    ...
    <main>
      ...
      <section id="top" className="hero">
        <div className="hero-copy">
          ...
          <div className="trust-row"><span>Free sample search</span><span>CSV export</span><span>Stripe checkout</span><span>Manual lead packs</span></div>
        </div>
      ...
      <section id="demo" className="section demo-section">
        <div className="section-heading">
          ...
          <p>Run a sample search to preview the lead scoring and outreach format. Paid lead packs are prepared and delivered by email.</p>
        </div>
        <div className="demo-grid">
          ...
          <div className="results">
            {leads.length === 0 ? <div className="empty"><h3>Your sample leads will appear here</h3><p>Run a search to preview the lead-pack format before choosing a plan.</p></div> : null}
            {leads.map((lead) => (
            ...
            {leads.length > 0 ? <button className="button secondary full" onClick={exportCsv}>Export sample CSV</button> : null}
          </div>
        </div>
      </section>
      ...
      <section id="how" className="section alt">
        ...
        <div className="cards">
          ...
          <article><span>02</span><h3>Find buying signals</h3><p>MarketVibe looks for signs like missing booking, weak contact flow, poor SEO pages, and missing automation.</p></article>
      ...
      <section className="section content-grid">
        <article className="seo-copy">
          <h2>AI lead packs for local service sellers</h2>
          ...
          <p>Each paid pack is prepared around the niche, city, and service you are targeting, then delivered as a CSV with outreach angles you can act on.</p>
        </article>
      ...
      <section id="pricing" className="section pricing">
        <div className="section-heading"><p className="eyebrow">Lead packs and monthly plans</p><h2>Start with a low-ticket lead pack.</h2><p>Choose a plan, then send your niche, city, and service after checkout so your lead pack can be prepared.</p></div>
        <div className="pricing-grid">
          <article><h3>Starter</h3><strong>$9</strong><p>One-time lead pack for beginners.</p><ul><li>25 leads</li><li>Pain-point summaries</li><li>Cold email template</li><li>Delivered by email</li></ul><a className="button secondary full" href={starterUrl}>Buy lead pack</a></article>
          <article className="featured"><p className="badge">Most popular</p><h3>Pro</h3><strong>$29/mo</strong><p>Best for freelancers doing weekly outreach.</p><ul><li>250 leads/month</li><li>CSV exports</li><li>Outreach scripts</li><li>Email delivery</li></ul><a className="button primary full" href={proUrl}>Start Pro</a></article>
      ...
      <section id="faq" className="section alt faq">
        ...
        <details><summary>Is the free demo real lead data?</summary><p>The free demo shows sample lead-pack formatting so you can see how the CSV, scoring, and outreach angles work before buying.</p></details>
        <details><summary>What happens after I pay?</summary><p>You will receive checkout confirmation from Stripe. Reply with your target niche, city, and service, and your lead pack will be prepared and delivered by email.</p></details>
        <details><summary>Can I request a specific niche or city?</summary><p>Yes. Paid lead packs are built around your requested industry, location, and service offer.</p></details>
      </section>

      <section className="cta"><h2>Start your next outreach campaign with MarketVibe AI.</h2><p>Pick a niche, choose a city, and get leads with clear outreach angles you can act on.</p><a className="button light" href="#pricing">Choose a plan</a></section>
